...
void setup() {
  ...
  */
  ...
  mpu.setXAccelOffset(-0.69);
  mpu.setXAccelOffset(4.45);
  //mpu.setZAccelOffset(100); // 1688 factory default for my test chip

  mpu.setXGyroOffset(.13);
  mpu.setYGyroOffset(-0.14);
  mpu.setZGyroOffset(-0.59);
